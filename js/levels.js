...
function createFirstLevel()
{
  return new Level("Starter", [
    ...
    [door.blood, door.both, door.top, door.marina, door.treasureKey, door.drawn, door.night],
    [door.blood, door.boat, door.river, desert.universe, door.cake, door.newYear],
  ]);
}
