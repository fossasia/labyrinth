...
function createTestLevel()
{
  return new Level([
    ...
    [NullTile, door.none, door.river, door.none, door.cake, door.newYear],
  ]);
  ...
  return new Level([
    ...
    [door.none, door.top, door.both, door.Saarthak, door.both, door.top, door.top, door.left, door.right],
