...
function createSuperheroLevel() {
  return new Level([
    ...
    [Superhero.none, Superhero.first, Superhero.new, Superhero.second, Superhero.both, Superhero.second],
    [Superhero.none, Superhero.first, PlayerStartsAt(Superhero.start), Superhero.new, Superhero.both, Superhero.top],
