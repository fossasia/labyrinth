const NullTile = {
 ...
 +    this.wallTop = this.createImage("tiles/rooms/door/doorSuper.svg");
 +    this.wallRight = this.createImage("tiles/rooms/door/wallt.svg");
 +    this.ground = this.createImage("tiles/rooms/floor/joker.svg");
 +  },
 +  // private
 +  placeAtIn: function(position, level) {
 ...
 +    createImages: function() {
 +      this.wallTop = this.createImage("tiles/rooms/wall/doorSuper.svg");
 +      this.wallRight = this.createImage("tiles/rooms/door/doorSuper.svg");
 +      this.ground = this.createImage("tiles/rooms/floor/superman.svg");
 +    },
 +  }),
 ...
 +    createImages: function() {
 +      this.wallTop = this.createImage("tiles/rooms/door/doorSuper.svg");
 +      this.wallRight = this.createImage("tiles/rooms/wall/wallt.svg");
 ...
 +  }),
    ...
    createImages: function() {
      this.wallTop = this.createImage("tiles/rooms/door/doorSuper.svg");
      this.wallRight = this.createImage("tiles/rooms/door/wallt.svg");
      this.ground = this.createImage("tiles/animations/wonder.svg");
    },
      visit: function() {
        swal({
          type: 'info',
          title: 'Nice one you have reached the goal',
        });
        this.wallTop.show();
        this.wallRight.show();
        this.ground.show();
 ...
 +      this.wallTop = this.createImage("tiles/rooms/door/doorSuper.svg");
 +      this.wallRight = this.createImage("tiles/rooms/wall/wallt.svg");
 +      this.ground = this.createImage("tiles/rooms/floor/flash.svg");
 +    },
 +  }),
 ...
 +    createImages: function() {
 +      this.wallTop = this.createImage("tiles/rooms/wall/doorSuper.svg");
 +      this.wallRight = this.createImage("tiles/rooms/wall/doorSuper.svg");
 +      this.ground = this.createImage("tiles/rooms/floor/spidey.svg");
 +    },
 +    visit: function() {
 +          swal({
 +          type: 'info',
 +          title: "Don't angry me!",
 +          text: "You better keep moving or else get webbed!",
 +        });
 +          this.wallTop.show();
 +          this.wallRight.show();
 +          this.ground.show();
